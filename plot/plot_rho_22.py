...
for ii in range(3):
	...
	axs[ii].legend(fontsize=14, loc='upper right')
...
plt.savefig('rho_n_22.png', transparent=True, quality=100)
...
plt.savefig('rho_c_22.png', transparent=True, quality=100)
...
fig.text(0.5, 0.02, r"$Z(nm)$", ha='center')
fig.text(0.01, 0.5, r"$Number \, density\, (nm^{-3})$",va='center' ,rotation='vertical')
plt.savefig('rho_n_22_c0-mbn.png', transparent=True, quality=100)