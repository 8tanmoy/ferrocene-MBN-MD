...
plt.savefig('rdf_NZ_OW_100.png', transparent=True, quality=100)
plt.clf()
...
fig.tight_layout()
ax1.legend(fontsize=14, loc='upper right')
plt.savefig('rdf_FE_OW_100.png', transparent=True, quality=100)
plt.clf()
...
fig.tight_layout()
ax1.legend(fontsize=14, loc='upper right')
plt.savefig('rdf_NZ_FE_100.png', transparent=True, quality=100)
plt.clf()